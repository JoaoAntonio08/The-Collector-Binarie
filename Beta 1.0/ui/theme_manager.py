...
class ThemeManager:
    ...
    def _setup_themes(self):
        ...
        self.dark_blue_style = """
            ...
            QTabWidget::pane { border: none; background-color: #0f0f2d; border-radius: 10px; }
            QTabBar::tab { background-color: #1e1e3f; color: #ffffff; border-top-left-radius: 8px; border-top-right-radius: 8px; padding: 8px 12px; margin-right: 2px; }
            QTabBar::tab:selected { background-color: #2d2d5a; border-bottom: 2px solid #bd93f9; }
            QTabBar::tab:hover { background-color: #3e3e5e; }
            QTabBar::close-button { subcontrol-position: right; }
            QTabBar::close-button:hover { background-color: #ff5555; border-radius: 4px; }
            
            QMenu { background-color: #0a0a23; color: #ffffff; border: 1px solid #1e1e3f; border-radius: 5px; }
            QMenu::item { padding: 8px 20px; }
            QMenu::item:selected { background-color: #1e1e3f; }
            
            QStatusBar { background-color: #0a0a23; color: #ffffff; border-top: 1px solid #1e1e3f; }
            
            QPlainTextEdit { background-color: #0f0f2d; color: #ffffff; border: none; font-family: 'Consolas', 'Courier New', monospace; font-size: 14px; selection-background-color: #2d2d5a; }
            QPlainTextEdit:focus { border: none; }
            
            QLineEdit { background-color: #1e1e3f; color: #ffffff; border-radius: 8px; padding: 4px; border: 1px solid #2d2d5a; }
            
            QTreeView { background-color: #0f0f2d; border: none; color: #ffffff; font-size: 12px; }
            QTreeView::item { padding: 4px; border-radius: 4px; }
            QTreeView::item:selected { background-color: #2d2d5a; }
            QTreeView::item:hover { background-color: #1e1e3f; }
        """
        ...
        self.dark_style = """
            ...
            QPlainTextEdit { background-color: #0a0a0a; color: #00ff00; border: none; font-family: 'Consolas', 'Courier New', monospace; font-size: 14px; selection-background-color: #2a2a2a; }
            QPlainTextEdit:focus { border: none; }
            
            QLineEdit { background-color: #1a1a1a; color: #00ff00; border-radius: 8px; padding: 4px; border: 1px solid #2a2a2a; }
            
            QTreeView { background-color: #0a0a0a; border: none; color: #00ff00; font-size: 12px; }
            QTreeView::item { padding: 4px; border-radius: 4px; }
        ...
        self.white_style = """
            ...
            QPlainTextEdit { background-color: #ffffff; color: #000000; border: none; font-family: 'Consolas', 'Courier New', monospace; font-size: 14px; selection-background-color: #d0d0d0; }
            QPlainTextEdit:focus { border: none; }
            
            QLineEdit { background-color: #ffffff; color: #000000; border-radius: 8px; padding: 4px; border: 1px solid #d0d0d0; }
            
            QTreeView { background-color: #ffffff; border: none; color: #000000; font-size: 12px; }
            QTreeView::item { padding: 4px; border-radius: 4px; }
